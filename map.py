...
#Add Marker
encoded1 = base64.b64encode(open('plots/posneg/shannon.png', "rb").read())
encoded2 = base64.b64encode(open('plots/posneg/ballyhoura.png', "rb").read())
encoded3 = base64.b64encode(open('plots/posneg/westfields.png', "rb").read())

html = '<img src="data:image/png;base64,{}">'.format
iframe1 = IFrame(html(encoded1.decode('UTF-8')), width=400, height=350)
popup1 = folium.Popup(iframe1, max_width=400)
iframe2 = IFrame(html(encoded2.decode('UTF-8')), width=400, height=350)
popup2 = folium.Popup(iframe2, max_width=400)
iframe3 = IFrame(html(encoded3.decode('UTF-8')), width=400, height=350)
popup3 = folium.Popup(iframe3, max_width=400)
